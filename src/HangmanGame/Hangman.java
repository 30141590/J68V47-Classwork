...
public class Hangman {
    ...
    public static void gamePlay(File Words, int option) {
        ...
        while (Lives != 0) {
            ...
            while (true) {
                ...
                if (Lives == 0) {
                    if (option == 1) {
                        File EasyHS = new File("C:\\Users\\notsl\\IdeaProjects\\J68V47-Classwork\\src\\HangmanGame\\easyHighScore.txt");
                        HSCheck(Score, EasyHS);
                    } else if (option == 2) {
                        File MedHS = new File("C:\\Users\\notsl\\IdeaProjects\\J68V47-Classwork\\src\\HangmanGame\\medHighScore.txt");
                        HSCheck(Score, MedHS);
                    } else {
                        File AdvHS = new File("C:\\Users\\notsl\\IdeaProjects\\J68V47-Classwork\\src\\HangmanGame\\advHighScore.txt");
                        HSCheck(Score, AdvHS);
                    }
    ...
    public static void main(String[] args) {
        ...
        File EasyHS = new File("easyHighScore.txt");
        File MedHS = new File("medHighScore.txt");
        File AdvHS = new File("advHighScore.txt");
        ...
        do {
            ...
            if (option == 1) {
                File EasyWords = new File("C:\\Users\\notsl\\IdeaProjects\\J68V47-Classwork\\src\\HangmanGame\\easyWords.txt");
                gamePlay(EasyWords, option);
            }else if (option == 2){
                File MedWords = new File("C:\\Users\\notsl\\IdeaProjects\\J68V47-Classwork\\src\\HangmanGame\\medWords.txt");
                gamePlay(MedWords, option);
            }else if (option == 3){
                File AdvWords = new File("C:\\Users\\notsl\\IdeaProjects\\J68V47-Classwork\\src\\HangmanGame\\advWords.txt");
